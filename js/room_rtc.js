const APP_ID = "4bc5dfad0eea44d9bac9c7abcec0c132";
...
let joinRoomInit = async () => {
  ...
  getMembers();
  addBotMessageToDom(`Welcome to the romm ${displayName} 👋`);
...
let handleUserPublish = async (user, mediaType) => {
  ...
  if (displayFrame.style.display) {
    let videoFram = document.getElementById(`user-container-${user.uid}`);
    videoFram.style.height = "100px";
    videoFram.style.width = "100px";
  }
  if (mediaType === "video") {
